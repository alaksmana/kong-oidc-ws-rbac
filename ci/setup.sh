...
export KONG_VERSION=${KONG_VERSION:-1.3.0-0}
export LUA_RESTY_OPENIDC_VERSION=${LUA_RESTY_OPENIDC_VERSION:-1.7.2-1}
...
luarocks install lrandom #trying for 1.7.2 upgrade
